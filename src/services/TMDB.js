...
export const {
    useGetGenresQuery,useGetMoviesQuery,useGetMovieInfoQuery,useGetRecommendationsQuery,useGetActorDetailsQuery,useGetMoviesByActorIdQuery,useGetListQuery
} = tmdbApi;